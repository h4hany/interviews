...
1. **JavaScript Basics** → `Frameworks/Frontend/basics/js.md`
2. **TypeScript** → `Frameworks/Frontend/basics/TypeScript.md`
3. **HTML** → `Frameworks/Frontend/basics/html.md`
4. **CSS** → `Frameworks/Frontend/basics/css.md`
...
23. **System Design Cheatsheet** → `System Design/System Design Cheatsheet.md`
24. **System Design Examples:**
    - **HR System** → `System Design/examples/HR System.md`
    - **Delivery System** → `System Design/examples/Delivery System.md`

### Phase 9: Architecture & Distributed Systems
25. **Microservices** → `Architecture/Microservices.md`
26. **Event-Driven Architecture** → `Architecture/Event-Driven Architecture.md`
27. **APIs** → `Architecture/APIs.md`
28. **Distributed Systems** → `Architecture/Distributed Systems.md`

### Phase 10: Infrastructure & DevOps
29. **Docker** → `Infrastructure/Docker.md`
30. **Kubernetes** → `Infrastructure/Kubernetes.md`
31. **DevOps** → `DevOps/DevOps.md`
32. **CI/CD** → `DevOps/CI_CD.md`
...
- **JavaScript** → `Frameworks/Frontend/basics/js.md`
  - Data types, hoisting, closures, event loop, promises, async/await, and more
- **TypeScript** → `Frameworks/Frontend/basics/TypeScript.md`
  - Types, interfaces, generics, utility types, decorators, and more
...
- **.NET Backend Deep Dive** → `Frameworks/Backend/dotNet/`
  ...
  - `02_system_design_FAANG.md` - System design for FAANG
  - `03_dotnet_backend_deep_dive.md` - .NET backend deep dive
  - `04_database_scaling.md` - Database scaling
  - `05_distributed_systems.md` - Distributed systems
  - `06_mock_interview_questions.md` - Mock interview questions
  - `07_live_mock_interview_mode.md` - Live mock interview
  - `08_gap_analysis.md` - Gap analysis
  - `09_daily_study_plan.md` - Daily study plan
...
- **MySQL** → `Databases/mysql.md`
  - ACID, BASE, normalization, indexes, transactions, replication, and more
- **PostgreSQL** → `Databases/postgresql.md`
  - JSONB, MVCC, indexes (B-tree, GIN, GiST), partitioning, replication, and more
- **MongoDB** → `Databases/mongodb.md`
  - NoSQL, document model, aggregation, indexing, sharding, and more
...
- **Microservices** → `Architecture/Microservices.md`
  - Principles, advantages/disadvantages, communication patterns, service discovery
- **Event-Driven Architecture** → `Architecture/Event-Driven Architecture.md`
  - Events, producers, consumers, event brokers, sagas, CQRS
...
- **Distributed Systems** → `Architecture/Distributed Systems.md`
  - CAP theorem, consistency models, consensus algorithms, fault tolerance
...
- **Docker** → `Infrastructure/Docker.md`
  - Containers, images, Dockerfile, volumes, networks, Docker Compose
- **Kubernetes** → `Infrastructure/Kubernetes.md`
  - Pods, deployments, services, namespaces, ingress, scaling
...
- **DevOps Fundamentals** → `DevOps/DevOps.md`
  - Principles, culture, tools, automation, infrastructure as code
- **CI/CD** → `DevOps/CI_CD.md`
  - Continuous integration, continuous deployment, pipelines, testing
- **Observability** → `DevOps/Observability.md`
  - Logging, metrics, tracing, alerting, tools (Prometheus, Grafana, ELK)
...
- **Full Interview Guide** → `Companies/toters/full_interview.md`
  - Technical interview (System Design, Backend Concepts, Problem-Solving)
  - Hiring Manager interview (Behavioral, Leadership)
...
- **Principal Engineer Master Q&A** → `Companies/oracle/Oracle_Principal_Engineer_MASTER_Interview_100_QA.md`
...
1. **System Design** - Scalability, load balancing, caching, databases
2. **Data Structures & Algorithms** - Arrays, trees, graphs, dynamic programming
3. **Object-Oriented Design** - Classes, inheritance, design patterns
4. **Databases** - SQL, NoSQL, transactions, indexing
5. **Backend Technologies** - APIs, microservices, distributed systems
6. **Frontend Technologies** - React, JavaScript, TypeScript
7. **DevOps** - Docker, Kubernetes, CI/CD
8. **Design Patterns** - Creational, Structural, Behavioral
9. **SOLID Principles** - Design principles for maintainable code

### Interview Types

- **Technical Interview**: Coding, system design, architecture
- **Behavioral Interview**: STAR method, leadership, teamwork
- **System Design Interview**: Scalability, reliability, performance
- **Object-Oriented Design Interview**: Classes, relationships, patterns

---

## 📝 Notes

- Each `.md` file contains comprehensive questions and detailed answers
- Files are organized by topic for easy navigation
- Follow the study order for systematic preparation
- Use company-specific guides for targeted preparation
- Review design patterns and SOLID principles for OOD interviews
