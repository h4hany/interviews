...
- [System Design 1. Design an RFI Management System](#system-design-1-design-an-rfi-management-system)
- [System Design 2. Design a Document and Drawing Management System](#system-design-2-design-a-document-and-drawing-management-system)
- [System Design 3. Design a Project Task / Punch List System](#system-design-3-design-a-project-task-punch-list-system)
- [System Design 4. Design a Notification System](#system-design-4-design-a-notification-system)
- [System Design 5. Design Permission and Audit System for Multi-Company Collaboration](#system-design-5-design-permission-and-audit-system-for-multi-company-collaboration)
- [System Design 6. Design Offline Mobile Sync for Field Teams](#system-design-6-design-offline-mobile-sync-for-field-teams)
- [System Design 7. Design Project Activity Feed](#system-design-7-design-project-activity-feed)
- [System Design 8. Design Webhook Delivery Platform](#system-design-8-design-webhook-delivery-platform)
- [System Design 9. Design Search Across Project Data](#system-design-9-design-search-across-project-data)
- [System Design 10. Design Reporting/Dashboard System](#system-design-10-design-reportingdashboard-system)
- [System Design 11. Design Budget / Cost Tracking System](#system-design-11-design-budget-cost-tracking-system)
- [System Design 12. Design Real-Time Comments](#system-design-12-design-real-time-comments)
- [System Design 13. Design Submittals Workflow](#system-design-13-design-submittals-workflow)
- [System Design 14. Design Observability Platform / Telemetry Pipeline](#system-design-14-design-observability-platform-telemetry-pipeline)
- [System Design 15. Design Monolith to Service Extraction for Permissions](#system-design-15-design-monolith-to-service-extraction-for-permissions)
- [System Design 16. Design API Rate Limiting](#system-design-16-design-api-rate-limiting)
- [System Design 17. Design Large File Upload System](#system-design-17-design-large-file-upload-system)
- [System Design 18. Design Event-Driven Audit Logging](#system-design-18-design-event-driven-audit-logging)
...
```text
Rails modular monolith + PostgreSQL for RFI data + S3 for attachments + 
Redis for counts/cache + Sidekiq for notifications/reminders + search index when full-text grows.
```
